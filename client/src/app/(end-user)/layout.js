...
import { Heart, User, Search, Bell } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="bg-root text-root-primary px-6 py-3 flex items-center justify-between">
        ...
        <Link href="/home" className="flex items-center space-x-2">
          <Image src="/logo.png" alt="Logo" width={80} height={80} className="" priority />
        </Link>
        ...
        <div className="flex-1 max-w-2xl mx-6">
          <div className="flex items-center border border-root rounded-md overflow-hidden bg-root">
            ...
            />
            <button className="px-4 text-root-primary hover:bg-primary hover:text-root-primary transition rounded-md" aria-label="Search">
        ...
        <div className="flex items-center space-x-6">
          <button className="relative hover:text-primary rounded-md p-1 cursor-pointer" aria-label="Notifications">
            <Bell className="w-6 h-6" />
          </button>
          <button className="hover:text-primary rounded-md p-1 cursor-pointer" aria-label="Favourites">
          ...
          <div ref={profileRef} className="relative">
            <button
              ...
              className="hover:text-primary flex items-center rounded-md p-1 cursor-pointer"
            >
      ...
      <div className="bg-root shadow-md relative z-40">
        <div className="flex justify-center space-x-10 py-3 text-root-primary font-medium">
          <Link href="/home" className="flex items-center space-x-2 hover:text-primary transition">
            <FaHome className="w-5 h-5" />
            <span>Home</span>
          </Link>

          <Link href="/events" className="flex items-center space-x-2 hover:text-primary transition">
            <FaCalendarAlt className="w-5 h-5" />
            <span>Events</span>
          </Link>

          {role === "professor" && (
            <Link href="/workshops" className="flex items-center space-x-2 hover:text-primary transition">
          ...
          {["student", "professor", "staff", "ta"].includes(String(role || "").toLowerCase()) && (
            <div ref={sportsRef} className="relative">
              ...
              >
                ...
                <span>Sports</span>
                <svg className="w-3 h-3 ml-1 opacity-70" viewBox="0 0 20 20" fill="currentColor">
          ...
          {/* Applications → /vendor-requests (vendors only) */}
          {role === "vendor" && (
            <Link
          ...
          <Link href="/about" className="flex items-center space-x-2 hover:text-primary transition">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          ...
          <p className="opacity-80 text-sm">
            <strong>UNINEST</strong> helps students and staff <em>Discover, Book, Attend</em> — find
            events, workshops, trips, and campus activities in one place.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/home" className="hover:bg-primary hover:text-root-primary px-1 rounded">Home</Link></li>
            <li><Link href="/events" className="hover:bg-primary hover:text-root-primary px-1 rounded">Events</Link></li>
            <li><Link href="/about" className="hover:bg-primary hover:text-root-primary px-1 rounded">About</Link></li>
            <li><Link href="/contact-us" className="hover:bg-primary hover:text-root-primary px-1 rounded">Contact</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <Link href="https://facebook.com" target="_blank" className="hover:bg-primary hover:text-root-primary px-1 rounded"><FaFacebook className="w-5 h-5" /></Link>
            <Link href="https://twitter.com" target="_blank" className="hover:bg-primary hover:text-root-primary px-1 rounded"><FaTwitter className="w-5 h-5" /></Link>
            <Link href="https://instagram.com" target="_blank" className="hover:bg-primary hover:text-root-primary px-1 rounded"><FaInstagram className="w-5 h-5" /></Link>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-root">
        <div className="max-w-6xl mx-auto px-6 py-4 text-xs opacity-70 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <Link href="/terms" className="hover:bg-primary hover:text-root-primary px-1 rounded">Terms</Link>
            <Link href="/privacy" className="hover:bg-primary hover:text-root-primary px-1 rounded">Privacy</Link>
          </div>
        </div>
      </div>
    </footer>
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-40 md:hidden bg-root text-root-primary border-t border-root">
      <ul className="flex justify-around items-center py-2 text-xs">
        <li><Link href="/" className="flex flex-col items-center gap-1 hover:bg-primary hover:text-root-primary px-2 py-1 rounded"><FaHome className="w-5 h-5" /><span>Home</span></Link></li>
        <li><Link href="/events" className="flex flex-col items-center gap-1 hover:bg-primary hover:text-root-primary px-2 py-1 rounded"><FaCalendarAlt className="w-5 h-5" /><span>Events</span></Link></li>
        <li><Link href="/vendor-requests" className="flex flex-col items-center gap-1 hover:bg-primary hover:text-root-primary px-2 py-1 rounded"><FaClipboardList className="w-5 h-5" /><span>Applications</span></Link></li>
        <li><Link href="/about" className="flex flex-col items-center gap-1 hover:bg-primary hover:text-root-primary px-2 py-1 rounded"><FaInfoCircle className="w-5 h-5" /><span>About</span></Link></li>
        <li><Link href="/contact-us" className="flex flex-col items-center gap-1 hover:bg-primary hover:text-root-primary px-2 py-1 rounded"><FaEnvelope className="w-5 h-5" /><span>Contact</span></Link></li>
      </ul>
    </nav>
  );
}
